...
export const DRAFT_PHASES: DraftStep[] = [
  // Phase 1 - Bans
  ...
  // Phase 3 - Second bans
  { type: 'ban', team: 'red', phase: 3, label: 'Ban 3' },
  { type: 'ban', team: 'blue', phase: 3, label: 'Ban 3' },
  // Phase 4 - Final picks
  { type: 'pick', team: 'red', phase: 4, label: 'Pick 4' },
  { type: 'pick', team: 'blue', phase: 4, label: 'Pick 4' },
  { type: 'pick', team: 'blue', phase: 4, label: 'Pick 5' },
